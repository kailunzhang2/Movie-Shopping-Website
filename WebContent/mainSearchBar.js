...
function handleLookup(query, doneCallback) {
    ...
    if(stored){
        ...
        handleLookupAjaxSuccess(stored, query, doneCallback)
        return;
    }
...
function handleSelectSuggestion(suggestion) {
    ...
    console.log("you select " + suggestion["value"] + " with ID " + suggestion["heroID"])
}
...
function handleNormalSearch(query) {
    ...
    window.location.replace("movie-list.html?search=true&title=" + query +"&year=&director=&star=");
